  ...
  return (
    <div className="relative w-full flex h-screen flex-wrap items-center justify-center overflow-hidden bg-black text-[calc(var(--size)*0.022)] text-white [--factor:min(1000px,100vh)] [--size:min(var(--factor),100vw)]">
      <div className="bg absolute h-full w-full max-w-[44em]">
        <div
          className="shadow-bgt absolute size-full scale-[1.2] animate-[onloadbgt_1s_ease-in-out_forwards] rounded-[100em] opacity-60"
          style={{ translate: '0 -70%' }}
        />
        <div
          className="shadow-bgb absolute size-full scale-[1.2] animate-[onloadbgb_1s_ease-in-out_forwards] rounded-[100em] opacity-60"
          style={{ translate: '0 70%' }}
        />
      </div>
