...
// required by background effects que referenciam tokens em runtime.
  ...
  theme: {
    extend: {
      colors: {
        ...
        // shadcn token layer — mapeado para a marca dark-teal PlexCare.
        border: '#15362F',
        input: '#15362F',
        ring: '#2DD4BF',
        background: '#04100E',
        ...
        success: { DEFAULT: '#22C55E', foreground: '#04100E' },
      },
      fontFamily: {
